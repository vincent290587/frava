...
public class SegmentEffortsApi {
     ...
     */
    public com.squareup.okhttp.Call getEffortsBySegmentIdCall(Integer segmentId, OffsetDateTime startDateLocal, OffsetDateTime endDateLocal, Integer perPage, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/segment_efforts";

        List<Pair> localVarQueryParams = new ArrayList<Pair>();
        List<Pair> localVarCollectionQueryParams = new ArrayList<Pair>();
        if (segmentId != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("segment_id", segmentId));
        if (startDateLocal != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("start_date_local", startDateLocal));
        if (endDateLocal != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("end_date_local", endDateLocal));
        if (perPage != null)
    ...
    private com.squareup.okhttp.Call getEffortsBySegmentIdValidateBeforeCall(Integer segmentId, OffsetDateTime startDateLocal, OffsetDateTime endDateLocal, Integer perPage, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'segmentId' is set
        if (segmentId == null) {
            throw new ApiException("Missing the required parameter 'segmentId' when calling getEffortsBySegmentId(Async)");
        }
        

        com.squareup.okhttp.Call call = getEffortsBySegmentIdCall(segmentId, startDateLocal, endDateLocal, perPage, progressListener, progressRequestListener);
        return call;
     ...
     */
    public List<DetailedSegmentEffort> getEffortsBySegmentId(Integer segmentId, OffsetDateTime startDateLocal, OffsetDateTime endDateLocal, Integer perPage) throws ApiException {
        ApiResponse<List<DetailedSegmentEffort>> resp = getEffortsBySegmentIdWithHttpInfo(segmentId, startDateLocal, endDateLocal, perPage);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<DetailedSegmentEffort>> getEffortsBySegmentIdWithHttpInfo(Integer segmentId, OffsetDateTime startDateLocal, OffsetDateTime endDateLocal, Integer perPage) throws ApiException {
        com.squareup.okhttp.Call call = getEffortsBySegmentIdValidateBeforeCall(segmentId, startDateLocal, endDateLocal, perPage, null, null);
     ...
     */
    public com.squareup.okhttp.Call getEffortsBySegmentIdAsync(Integer segmentId, OffsetDateTime startDateLocal, OffsetDateTime endDateLocal, Integer perPage, final ApiCallback<List<DetailedSegmentEffort>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getEffortsBySegmentIdValidateBeforeCall(segmentId, startDateLocal, endDateLocal, perPage, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<DetailedSegmentEffort>>(){}.getType();
