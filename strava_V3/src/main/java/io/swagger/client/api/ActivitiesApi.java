...
public class ActivitiesApi {
     ...
     */
    public com.squareup.okhttp.Call createActivityCall(String name, String type, OffsetDateTime startDateLocal, Integer elapsedTime, String description, Float distance, Integer trainer, Integer commute, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call createActivityValidateBeforeCall(String name, String type, OffsetDateTime startDateLocal, Integer elapsedTime, String description, Float distance, Integer trainer, Integer commute, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createActivityCall(name, type, startDateLocal, elapsedTime, description, distance, trainer, commute, progressListener, progressRequestListener);
        return call;
     ...
     */
    public DetailedActivity createActivity(String name, String type, OffsetDateTime startDateLocal, Integer elapsedTime, String description, Float distance, Integer trainer, Integer commute) throws ApiException {
        ApiResponse<DetailedActivity> resp = createActivityWithHttpInfo(name, type, startDateLocal, elapsedTime, description, distance, trainer, commute);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<DetailedActivity> createActivityWithHttpInfo(String name, String type, OffsetDateTime startDateLocal, Integer elapsedTime, String description, Float distance, Integer trainer, Integer commute) throws ApiException {
        com.squareup.okhttp.Call call = createActivityValidateBeforeCall(name, type, startDateLocal, elapsedTime, description, distance, trainer, commute, null, null);
     ...
     */
    public com.squareup.okhttp.Call createActivityAsync(String name, String type, OffsetDateTime startDateLocal, Integer elapsedTime, String description, Float distance, Integer trainer, Integer commute, final ApiCallback<DetailedActivity> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createActivityValidateBeforeCall(name, type, startDateLocal, elapsedTime, description, distance, trainer, commute, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<DetailedActivity>(){}.getType();
