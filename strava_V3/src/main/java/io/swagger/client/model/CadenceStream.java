...
public class CadenceStream {
  ...
  public CadenceStream originalSize(Integer originalSize) {
  ...
  **/
  ...
  public CadenceStream resolution(ResolutionEnum resolution) {
  ...
  **/
  ...
  public CadenceStream seriesType(SeriesTypeEnum seriesType) {
